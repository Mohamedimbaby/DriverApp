...
import 'package:driver_app/services/goofle_map_api.dart';
...
class _MapState extends State<Map> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          InkWell(
            onTap: () => shareMyLocationOnWhatsApp(),
            child: Container(
              width: 60,
              child: Icon(
                Icons.share,
  ...
  shareMyLocationOnWhatsApp() {
    final FlutterShareMe flutterShareMe = FlutterShareMe();

    flutterShareMe.shareToWhatsApp(
        msg:
            'https://www.google.com/maps/search/?api=1&query=${currentLocation?.latitude ?? 0.0},${currentLocation?.longitude ?? 0.0}',
    );
  }
}
