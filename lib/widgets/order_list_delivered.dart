...
import 'package:driver_app/controllers/global-controller.dart';
...
import 'package:driver_app/views/order/no_order_found_page.dart';
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                orders.orderHistoryList[index].customer!.id.toString(),
                                                style: TextStyle(
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                orders.orderHistoryList[index].customer!.name!,
                                                style: TextStyle(
                                                  overflow: TextOverflow.ellipsis,
                                                  // fontWeight: FontWeight.w300,
                                                  fontSize: 13,
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                orders.orderHistoryList[index].mobile!,
                                                style: TextStyle(
                                                  overflow: TextOverflow.ellipsis,
                                                  // fontWeight: FontWeight.w300,
                                                  fontSize: 13,
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              IconButton(onPressed: (){
                                                Get.to(CustomerLocation(LatLng(double.parse(orders.orderHistoryList[index]
                                                    .lat!),double.parse(orders.orderHistoryList[index]
                                                    .long!))));
