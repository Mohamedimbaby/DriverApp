import 'dart:convert';
import 'package:driver_app/models/notification_order.dart';
import 'package:driver_app/models/notification_order_history.dart';
  ...
  getAllOrders() async {
    ...
    server.getRequest(endPoint: APIList.notificationOrder).then((response) {
      if (response != null && response.statusCode == 200) {
        ...
        print(jsonResponse);
        var orderListData = NotificationOrder.fromMap(jsonResponse);
        orderList = <Order>[];
        print(orderListData);
